...
def parse(args):
    parser = argparse.ArgumentParser(
        description="Scrape the city council website for council member information.")
    subparser = parser.add_subparsers(
        dest="command", required=True)
    parser_scrape = subparser.add_parser(
        'scrape', description="Scrape the city council website for council member information.")
